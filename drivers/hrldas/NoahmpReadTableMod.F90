...
!=== read Noahmp Table values
  ...
  subroutine NoahmpReadTable(NoahmpIO)
    ...
    !-------------------------------------------------------
    integer, parameter :: MVT         = 33   ! number of vegetation types (27 stock USGS + 28-33 for this project's CORINE-remapped-as-USGS WPS_GEOG dataset; same as drivers/wrf)
